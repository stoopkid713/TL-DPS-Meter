...
- **Technical detection risk — low.** EAC bans are driven by things like injecting into the
  ...
  WebView2/Tauri window** ([`overlay/`](overlay/)) — its own process, **not** injected into
...
any third-party tool is free of consequences. Make your own informed decision.

---

## Reporting a vulnerability

Found a genuine security issue (not a false-positive AV flag)? Please report it privately
rather than opening a public issue:

- Use **GitHub → Security → Report a vulnerability** (private advisory) on this repository, or
- Contact the maintainer directly.

Please include the version, your OS, and steps to reproduce. We aim to acknowledge reports
promptly and will credit reporters who want it.
